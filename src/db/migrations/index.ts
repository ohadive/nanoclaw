...
// Local fork migrations — renumbered to 024/025/026 (upstream took 019–023).
// Dedup is by `name`, so these already-applied migrations won't re-run on
// existing installs; the higher numbers only affect fresh-DB ordering.
import { migration024 } from './024-agent-group-pause.js';
import { migration025 } from './025-agent-console.js';
import { migration026 } from './026-container-env-disallowed-tools.js';
